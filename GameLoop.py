...
def GameLoop(gameboard):
        ...
        while go == True:
                ...
                test = input("Did bench change?")
                if test == 'yes':
                        getPlayerBench(gameboard)

                #Get player's hand
                test = input("Did hand change")
                if test == 'yes':
                        getPlayerHand(gameboard)

                #Get player's discard
                test = input("Did discard change")
                if test == 'yes':        
                ...
                #get player's prizes
                #if len(gameboard.playerPrize) == 0:
                getPlayerPrize(gameboard)

                # Get opponents active pokemon
                test = input("Did opponent's active change")
                if test == 'yes':
                        getOppActive(gameboard)

                #Get opponent's benched pokemon
                test = input("Did opponent's bench change")
                if test == 'yes':
                        getOppBench(gameboard)

                #Get opponents discard
                test = input("Did opponent's discard change")
                if test == 'yes':
...
def getPlayerPrize(gameboard):
        goodData = False
        x = input("Did prizes change?")
        if x == 'yes':
                x = input("How many prizes were taken by player?")
                for i in range(int(x)):
                        gameboard.playerHand.append(gameboard.playerPrize.pop(0))
##        else:
##                
...
def getOppPrize(gameboard):
        ...
        x = input("Did prizes change?")
        if x == 'yes':
                x = input("How many prizes were taken by opponent?")
                for i in range(int(x)):
                        gameboard.oppHand.append(gameboard.oppPrize.pop(0))
...
def getPlayerHand(gameboard):
        ...
        while more == True:
                while entered == True:
                        print("What card was added to the players hand?")
                        temp = input()
                        if temp == '':
                                entered = False
                                more = False
...
def getPlayerDiscard(gameboard):
        ...
        while more == True:
                while entered == True:
                        print("What card was added to the players discard?")
                        temp = input()
                        if temp == '':
                                entered = False
                                more = False
...
def getOppDiscard(gameboard):
        ...
        while more == True:
                while entered == True:
                        print("What card was added to the opponent's discard?")
                        temp = input()
                        if temp == '':
                                entered = False
                                more = False
...
def getPlayerActive(gameboard):
        flag = True
        i = 0
        print(len(gameboard.playerActive))
        if len(gameboard.playerActive) > 0:
                x = input("Is " + gameboard.playerActive[0].Name + " still active?")
                if x == 'yes':
                        x = input("Did you add any energies to active?")
                        if x == 'yes':
                        ...
                        x = input("Did active get damaged last turn?")
                        if x == 'yes':
                                #Get damage for active
                                print("How much damage ihappened last turn?")
                                temp = input()
                                if temp == '':
                                        temp = 0
                ...
                if temp == '':
                        temp = 0
                gameboard.playerActive[0].Hp -= int(temp)
##                if gameboard.playerActive[0].Hp <= 0:
##                        gameboard.playerPrize
